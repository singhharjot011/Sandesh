...
function MessageInput() {
  ...
  const { dispatch, typedText, selectedInteractor } = useChat();
  ...
  function handleSendMessage(e) {
    ...
    dispatch({ type: "typedText/typing", payload: "" });
  }

  return (
    <form className="my-auto" onSubmit={() => {}}>
      ...
      <div className="flex items-center px-3 py-2 rounded-lg bg-gray-50 dark:bg-gray-700">
        ...
        <textarea
          ...
          value={typedText}
          onChange={(e) => {
            dispatch({ type: "typedText/typing", payload: e.target.value });
          }}
          onKeyDown={(e) => {
