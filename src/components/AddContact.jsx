...
function AddContact() {
  const { dispatch, contacts } = useChat();
  ...
  return (
    <div className="w-4/5 flex flex-col absolute right-0 h-full">
      <div className="flex w-full  p-4 pt-16 overflow-y-auto flex-grow">
        <form className="p-6 w-1/2" onSubmit={(e) => handleAddContact(e)}>
          ...
          <button
            type="submit"
            className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 me-2"
          >
            Add Contact
          </button>
          <button
